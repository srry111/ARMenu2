...
public class Dessert extends AppCompatActivity implements  SearchView.OnQueryTextListener{

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static String URL_food = "https://limch-wa15.000webhostapp.com/item1.php?foodid=39";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new FoodAdapter(my.edu.tarc.armenu.Foodlist.Dessert.this, food);
